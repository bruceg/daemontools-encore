...
clean:
        ...
        setlock setlock.o setlock2 setlock2.o as_user as_user.o wrapper wrapper.o \
        setuidgid setuidgid.o sgetopt.o sig.o sig_block.o \
...
setlock2: byte.a load setlock2.o unix.a
        ./load setlock2 unix.a byte.a 

setlock2.o: compile lock.h open.h pathexec.h setlock2.c sgetopt.h \
strerr.h subgetopt.h
        ./compile setlock2.c

as_user: byte.a load as_user.o unix.a
        ./load as_user unix.a byte.a 

as_user.o: compile pathexec.h as_user.c strerr.h
        ./compile as_user.c

wrapper: wrapper.o
        gcc -g -Wall wrapper.o -o wrapper

wrapper.o: wrapper.c
        gcc -g -Wall -c wrapper.c
